...
const statuses = ['new', 'reviewed', 'calendar_meeting', 'confirmed', 'contacted', 'closed_won', 'closed_lost', 'rejected']
...
const sampleEnquiries = [
  ...
  { speakerId: 'steven-bartlett', speakerName: 'Steven Bartlett', name: 'James Richardson', email: 'james.r@bankgroup.com', organization: 'National Bank Group', phone: '+44 20 7946 0958', eventDate: '2026-03-28', eventLocation: 'London, The Savoy', audienceSize: '200-500', budgetRange: '£50,000+', eventType: 'corporate-event', brief: 'Private leadership dinner for our top 200 executives. We would like Steven for an intimate 30-minute talk on trust and ambition.', status: 'contacted', daysAgo: 12 },

  // Jordan Schwarzenberger (2)
  { speakerId: 'jordan-schwarzenberger', speakerName: 'Jordan Schwarzenberger', name: 'Sophie Turner', email: 'sophie@brandlabs.io', organization: 'BrandLabs', eventDate: '2026-05-05', eventLocation: 'London, Shoreditch Studios', audienceSize: '200-500', budgetRange: '£5,000-£10,000', eventType: 'workshop', brief: 'Workshop on creator economy for brand managers. Want Jordan to break down how modern brands are actually built through community and content.', status: 'confirmed', daysAgo: 8 },
  ...
  // Nischa Shah (2)
  { speakerId: 'nischa-shah', speakerName: 'Nischa Shah', name: 'Emma Collins', email: 'emma@finlit.org', organization: 'Financial Literacy Trust', eventDate: '2026-04-08', eventLocation: 'London, Kings Place', audienceSize: '200-500', budgetRange: '£5,000-£10,000', eventType: 'conference', brief: 'Youth financial literacy conference. Nischa to speak about money anxiety, career pressure, and making smart financial decisions in your 20s.', status: 'confirmed', daysAgo: 18 },
