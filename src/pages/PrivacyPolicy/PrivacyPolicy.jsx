    ...
    <div className="privacy-page">
      ...
      <ul>
        ...
        <li>Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement)
          refers to FLIGHTSTORY, 73 Cornhill, London, EC3V 3QQ.</li>
        ...
        <li>Service Provider means any natural or legal person who processes the data on behalf of
          ...
          services related to the Service or to assist the Company in analysing how the Service is
          used.</li>
        <li>Usage Data refers to data collected automatically, either generated by the use of the
          ...
          visit).</li>
        <li>Website refers to www.flightstory.com, accessible from www.flightstory.com</li>
      ...
      <p>We use Cookies and similar tracking technologies to track the activity on Our Service and
        ...
        collect and track information and to improve and analyse Our Service. The technologies We
        use may include:</p>
      <p>Cookies or Browser Cookies.<br />A cookie is a small file placed on Your Device. You can
        ...
        may use Cookies.</p>
      <p>Web Beacons.<br />Certain sections of our Service and our emails may contain small electronic
      ...
      <p>Necessary / Essential Cookies<br />Type: Session Cookies<br />Administered by:
        Us<br />Purpose: These Cookies are essential to provide You with services available through
        ...
        services.</p>
      <p>Cookies Policy / Notice Acceptance Cookies<br />Type: Persistent Cookies<br />Administered
        by: Us<br />Purpose: These Cookies identify if users have accepted the use of cookies on the
        Website.</p>
      <p>Functionality Cookies<br />Type: Persistent Cookies<br />Administered by: Us<br />Purpose:
      ...
      <p>To provide and maintain our Service including to monitor the usage of our Service.<br />To
        ...
        available to You as a registered user.<br />For the performance of a contract: the
        development, compliance and undertaking of the purchase contract for the products, items or
        services You have purchased or of any other contract with Us through the Service.<br />To
        contact You: To contact You by email, telephone calls, SMS, or other equivalent forms of
        ...
        implementation.<br />To provide You with news, special offers and general information about
        ...
        information.<br />To manage Your requests: To attend and manage Your requests to Us.</p>
      <p>For business transfers: We may use Your information to evaluate or conduct a merger,
      ...
      <p>With Service Providers: We may share Your personal information with Service Providers to
        monitor and analyze the use of our Service, to contact You.</p>
      <p>For business transfers: We may share or transfer Your personal information in connection
        with, or during negotiations of, any merger, sale of Company assets, financing, or
        acquisition of all or a portion of Our business to another company.<br />With Affiliates: We
        may share Your information with Our affiliates, in which case we will require those
        ...
        common control with Us.<br />With business partners: We may share Your information with Our
        business partners to offer You certain products, services or promotions.<br />With other
        users: when You share personal information or otherwise interact in the public areas with
        other users, such information may be viewed by all users and may be publicly distributed
        outside.<br />With Your consent: We may disclose Your personal information for any other
      ...
      <p>By email: contact@flightstory.com</p>
    </div>
  );
}
