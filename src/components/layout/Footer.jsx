        ...
        <div className="footer-content">
          ...
          <div className="footer-links">
            ...
            <div className="footer-section">
              ...
              <ul>
                <li><a href="https://linkedin.com/company/flightstory" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
                <li><a href="https://twitter.com/flightstory" target="_blank" rel="noopener noreferrer">Twitter</a></li>
              </ul>
            </div>
          </div>
        </div>
